...
class ProfileModel {
  ...
  ProfileModel.fromJson(Map<String, dynamic> json) {
    ...
    biometricLoginStatus = json['biometric_login_status'];
    imageFullUrl = json['identity_image'];
  ...
  Map<String, dynamic> toJson() {
    ...
    data['biometric_login_status'] = biometricLoginStatus;
