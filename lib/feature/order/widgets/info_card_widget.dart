...
import 'package:stackfood_multivendor_driver/common/widgets/verified_seller_widget.dart';
    ...
    return DetailsCustomCard(
      ...
      child: Column(crossAxisAlignment: CrossAxisAlignment.start, mainAxisAlignment: MainAxisAlignment.center, children: [
        ...
        (name != null && name!.isNotEmpty) ? Row(crossAxisAlignment: CrossAxisAlignment.start, children: [
          ClipOval(child: CustomImageWidget(image: image, height: 50, width: 50, fit: BoxFit.cover)),
          const SizedBox(width: Dimensions.paddingSizeSmall),

          Expanded(child: Column(crossAxisAlignment: CrossAxisAlignment.start, mainAxisAlignment: MainAxisAlignment.center, children: [
            Row(crossAxisAlignment: CrossAxisAlignment.start, children: [
              Flexible(child: Text(name ?? '', style: robotoBold.copyWith(fontSize: Dimensions.fontSizeSmall))),
              if(isRestaurant && (orderModel?.verifiedSeller ?? false)) ...[
                const SizedBox(width: Dimensions.paddingSizeExtraSmall),
                VerifiedSellerWidget(isVerified: orderModel!.verifiedSeller!),
              ],
            ]),
            ...
            isRestaurant ? Row(children: [
              ...
              const SizedBox(width: Dimensions.paddingSizeExtraSmall),
              Text('(${3.3})', style: robotoRegular.copyWith(fontSize: Dimensions.fontSizeSmall, color: Theme.of(context).hintColor),),
            ]) : const SizedBox(),
          ])),
          const SizedBox(width: Dimensions.paddingSizeSmall),
          ...
          showButton ? Row(children: [
            InkWell(
              ...
              child: CustomAssetImageWidget(image: Images.chatIcon, height: 25, width: 25),
            ),
            ...
            orderModel != null ? InkWell(
              ...
              child: CustomAssetImageWidget(image: Images.callIcon, height: 25, width: 25),
            ) : const SizedBox(),
            ...
            InkWell(
              ...
              child: Container(
                height: 25, width: 25,
                decoration: BoxDecoration(shape: BoxShape.circle, color: Color(0xff9DA7BC)),
