        ...
        return Scaffold(
          ...
          body: Padding(
            ...
            child: GetBuilder<OrderController>(builder: (orderController) {
              ...
              bool deliveryManConfModel =configModel?.orderConfirmationModel == 'deliveryman';
              bool restaurantConfModel =configModel?.orderConfirmationModel != 'deliveryman';

              late bool showBottomView;
              late bool showSlider;
              bool showDeliveryConfirmImage = orderController.showDeliveryImageField && configModel!.dmPictureUploadStatus!;
              ...
              if(order != null && orderController.orderDetailsModel != null ) {
                ...
                proDiscount = order.proDiscount ?? 0;
              ...
              print("item price $itemsPrice");


              double subTotal = itemsPrice + addOns;
              print("sub total $subTotal");

              double total = itemsPrice + addOns - discount! + (taxIncluded! ? 0 : tax!) + deliveryCharge! - couponDiscount! - proDiscount + dmTips! + additionalCharge + extraPackagingAmount - referrerBonusAmount + (order?.deliveryType == 'slightly_delay' ? -deliveryTypeCharge : deliveryTypeCharge);
              ...
              if(controllerOrderModel != null){
                ...
                showSlider = (controllerOrderModel.paymentMethod == 'cash_on_delivery' && controllerOrderModel.orderStatus == 'accepted' && !restaurantConfModel && !selfDelivery)
              ...
              return (orderController.orderDetailsModel != null && controllerOrderModel != null && order != null) ? Column(children: [
                ...
                Expanded(child: SingleChildScrollView(
                  child: Column(children: [
                    ...
                    InfoCardWidget(
                      title: 'customer_details'.tr, addressModel: controllerOrderModel.deliveryAddress, isDelivery: true,
                    ...
                    DetailsCustomCard(
                      ...
                      child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                        ...
                        Row(children: [
                          ...
                          const Expanded(child: SizedBox()),
                          Text(deliveryManConfModel ? PriceConverter.convertPrice(subTotal) : PriceConverter.convertPrice(total - dmTips), style: robotoMedium, textDirection: TextDirection.ltr),
                        ]),
                        const SizedBox(height: Dimensions.paddingSizeSmall),

                        deliveryManConfModel && discount != 0.0 ? Row(mainAxisAlignment: MainAxisAlignment.spaceBetween, children: [
                          Text('discount'.tr, style: robotoRegular.copyWith(color: Theme.of(context).hintColor)),
                          Text('(-) ${PriceConverter.convertPrice(discount)}', style: robotoMedium.copyWith(color: Theme.of(context).primaryColor), textDirection: TextDirection.ltr),
                        ]) : const SizedBox(),
                        deliveryManConfModel && discount != 0.0 ? const SizedBox(height: Dimensions.paddingSizeSmall) : SizedBox.shrink(),

                        deliveryManConfModel && couponDiscount != 0.0 ? Row(mainAxisAlignment: MainAxisAlignment.spaceBetween, children: [
                          Text('coupon_discount'.tr, style: robotoRegular.copyWith(color: Theme.of(context).hintColor)),
                          Text('(-) ${PriceConverter.convertPrice(couponDiscount)}', style: robotoMedium.copyWith(color: Theme.of(context).primaryColor), textDirection: TextDirection.ltr),
                        ]) : const SizedBox(),
                        deliveryManConfModel && couponDiscount != 0.0 ? const SizedBox(height: Dimensions.paddingSizeSmall) : SizedBox.shrink(),

                        deliveryManConfModel && proDiscount > 0 ? Row(mainAxisAlignment: MainAxisAlignment.spaceBetween, children: [
                          Text('pro_discount'.tr, style: robotoRegular.copyWith(color: Theme.of(context).hintColor)),
                          Text('(-) ${PriceConverter.convertPrice(proDiscount)}', style: robotoMedium.copyWith(color: Theme.of(context).primaryColor), textDirection: TextDirection.ltr),
                        ]) : const SizedBox(),
                        deliveryManConfModel && proDiscount > 0 ? const SizedBox(height: Dimensions.paddingSizeSmall) : SizedBox.shrink(),

                        deliveryManConfModel && tax != 0.0 ? Row(mainAxisAlignment: MainAxisAlignment.spaceBetween, children: [
                          Text('vat_tax'.tr, style: robotoRegular.copyWith(color: Theme.of(context).hintColor)),
                          Text('(+) ${PriceConverter.convertPrice(tax)}', style: robotoMedium.copyWith(color: Theme.of(context).primaryColor), textDirection: TextDirection.ltr),
                        ]) : const SizedBox(),
                        deliveryManConfModel && tax != 0.0 ? const SizedBox(height: Dimensions.paddingSizeSmall) : SizedBox.shrink(),

                        deliveryManConfModel && order.deliveryType != null && showDeliveryTypeCharge ? Row(mainAxisAlignment: MainAxisAlignment.spaceBetween, children: [
                          Text('${order.deliveryType?.replaceAll('_', ' ').capitalize} ${'delivery'.tr}' , style: robotoRegular.copyWith(color: Theme.of(context).hintColor)),
                          Text('(${order.deliveryType == 'slightly_delay' ? '-' : '+'}) ${PriceConverter.convertPrice(deliveryTypeCharge)}', style: robotoMedium.copyWith(color: Theme.of(context).primaryColor), textDirection: TextDirection.ltr),
                        ]) : const SizedBox(),
                        deliveryManConfModel && showDeliveryTypeCharge ? const SizedBox(height: Dimensions.paddingSizeSmall) : SizedBox.shrink(),

                        deliveryManConfModel && deliveryCharge != 0.0 ? Row(mainAxisAlignment: MainAxisAlignment.spaceBetween, children: [
                          Text('delivery_fee'.tr, style: robotoRegular.copyWith(color: Theme.of(context).hintColor)),
                          Text('(+) ${PriceConverter.convertPrice(deliveryCharge)}', style: robotoMedium.copyWith(color: Theme.of(context).primaryColor), textDirection: TextDirection.ltr),
                        ]) : const SizedBox(),
                        deliveryManConfModel && deliveryCharge != 0.0 ? const SizedBox(height: Dimensions.paddingSizeSmall) : SizedBox.shrink(),

                        deliveryManConfModel && additionalCharge != 0.0 ? Row(mainAxisAlignment: MainAxisAlignment.spaceBetween, children: [
                          Text('additional_charge'.tr, style: robotoRegular.copyWith(color: Theme.of(context).hintColor)),
                          Text('(+) ${PriceConverter.convertPrice(additionalCharge)}', style: robotoMedium.copyWith(color: Theme.of(context).primaryColor), textDirection: TextDirection.ltr),
                        ]) : const SizedBox(),
                        deliveryManConfModel && additionalCharge != 0.0 ? const SizedBox(height: Dimensions.paddingSizeSmall) : SizedBox.shrink(),

                        dmTips != 0.0 ? Row(mainAxisAlignment: MainAxisAlignment.spaceBetween, children: [
                         ...
                         Divider(height: 20, color: Theme.of(context).hintColor.withValues(alpha: 0.3)),
                ...
                SafeArea(
                  child: showDeliveryConfirmImage && controllerOrderModel.orderStatus != 'delivered' ? Container(
                  ...
                  ) : showBottomView ? ((controllerOrderModel.orderStatus == 'accepted' && (controllerOrderModel.paymentMethod != 'cash_on_delivery' || restaurantConfModel || selfDelivery))
                  ...
                  ) : showSlider ? (controllerOrderModel.paymentMethod == 'cash_on_delivery' && controllerOrderModel.orderStatus == 'accepted' && !restaurantConfModel && cancelPermission! && !selfDelivery) ? CustomCard(
                    padding: const EdgeInsets.all(Dimensions.paddingSizeDefault),
                    isBorder: false,
                    child: Row(children: [
                    ...
                    child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                      ...
                      SliderButtonWidget(
                        action: () {
                          if(controllerOrderModel.paymentMethod == 'cash_on_delivery' && controllerOrderModel.orderStatus == 'accepted' && !restaurantConfModel && !selfDelivery) {
                            showCustomBottomSheet(
                              child: CustomConfirmationBottomSheet(
                                title: 'are_you_sure_to_confirm'.tr,
                                description: 'you_want_to_confirm_this_order'.tr,
                        ...
                        label: Text(
                          (controllerOrderModel.paymentMethod == 'cash_on_delivery' && controllerOrderModel.orderStatus == 'accepted' && !restaurantConfModel && !selfDelivery)
